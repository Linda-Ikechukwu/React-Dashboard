...
const rowsData = [
    createData('108737NT', 'Nsikan Etukudoh', 'Tammy Jerome','Emmanuel Osaretin','Atiku Abubakar rd','124 Oron rd. Uyo ','Breakable','N350', '15th Jul, 2020','15th Jul, 2020','15th Jul, 2020','now'),
    createData('108737NT', 'Nsikan Etukudoh', 'Tammy Jerome','Emmanuel Osaretin','Atiku Abubakar rd','124 Oron rd. Uyo ','Breakable','N350', '15th Jul, 2020','15th Jul, 2020','15th Jul, 2020','now'),
];


const OngoingRidesTable = () => {
...
export default OngoingRidesTable ;